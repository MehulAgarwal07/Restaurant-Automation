...
<button class="btn cyan waves-effect waves-light right" type="submit" name="action" onclick="myFunction()" <?php if($_POST['payment_type'] == 'Wallet') {if ($balance-$total < 0) {echo 'disabled'; }}?>>Confirm Order

<i class="mdi-content-send right"></i>
</button>
<script>
function myFunction() {
  alert("Order Confirmed and Placed");
}
</script>
</div>
</form>
